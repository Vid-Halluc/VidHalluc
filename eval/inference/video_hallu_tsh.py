...
if __name__ == "__main__":
    ...
    for index, video_dict in videos_dict.items():
        ...
        # Call main()
        inp = question
        inp += "Sort these two actions in the order they occur in the video, and return the order you detect (i.e., AB or BA). If you only detect one action of these two in the video, return that action."
